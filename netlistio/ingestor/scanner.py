...
class ScanContext:
    ...
    regions: deque[ParseRegion] = field(default_factory=deque)
...
class Scanner:
    ...
    def _handle_macro_line(self, line: bytes, _: int, nxt: int) -> None:
        """
        Processes a line inside macro scope.

        :param line: Raw line bytes.
        :param _: Current byte offset (unused; nxt is sufficient).
    ...
    def scan(self) -> deque[ParseRegion]:
        ...
        """
        self.context = ScanContext(scan_strategy=self.context.scan_strategy)
